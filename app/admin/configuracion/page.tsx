        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Configuración del Formulario</h1>
                <p className="text-sm text-gray-600">Gestionar opciones y categorías del formulario</p>
              </div>
            </div>
